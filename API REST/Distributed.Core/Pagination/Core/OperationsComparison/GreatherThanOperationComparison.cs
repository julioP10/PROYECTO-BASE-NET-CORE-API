...
{
    public class GreatherThanOperationComparison : IOperationComparison
    {
           ...
           where T : class
        {
            ...
            return expressionValue == default ? default(Expression) : BaseOperationComparison.GreaterThanOrEqualNullable(lambdaAccess, expressionValue);
        }
    }
}