...
{
    public class NotEqualsOperationComparison : IOperationComparison
    {
         ...
         where T : class
        {
            ...
            return expressionValue == default ? default(Expression) : Expression.NotEqual(lambdaAccess, expressionValue);
        }
    }
}